...
const _accordionsInfluencer = [
  {
    ...
    // defaultOpen: true,
    detail:
      'ב-Influencer-Pro אנחנו לא רק מבטיחים אלא גם מתחייבים להצלחה שלך, עם תכנית לימודים שמבוססת על שיטות מוכחות, תמיכה מקצועית, וליווי אישי. הקורס כולל הדרכה ישירה ממומחים שעברו את הדרך והצליחו, כך שאתה מקבל ידע וכלים מעשיים שעובדים בשטח. בנוסף, אנחנו מציעים התחייבות מלאה – אם לאחר הקורס לא הצלחת להשיג את העבודה הראשונה שלך בתחום, אנחנו מתחייבים להחזיר לך את כל כספך. זו הדרך שלנו להראות שאנחנו מאמינים בקורס וביכולת שלו להוביל אותך להצלחה.עם הקורס הזה אתה לא לבד – אנחנו נלווה אותך לאורך כל הדרך, ההצלחה שלך היא ההצלחה שלנו',
  },
  {
    id: 2,
    value: 'value_2',
  ...
  },
  {
    ...
    detail:
      'לא ממש, הקורס מתאים ליוצרי תוכן עם ניסיון שיש להם מעל 10 אלף עוקבים באחת מהפלטפורמות החברתיות : טיקטוק, יוטיוב או אינסטגרם או שבחודש הקרוב תגיע לרף ה-10 אלף עוקבים הקורס הזה הוא בשבילך.',
  },
  {
    id: 5,
    value: 'value_5',
...
export function AccordionView({ title, influencer = false, accordions = _accordions, mode = 0 }) {
  ...
  if (mode === 1) {
    ...
    if (influencer) {
      accordions = _accordionsInfluencer;
    }
    accordionDiv = (
      <ComponentBlock
        sx={{
