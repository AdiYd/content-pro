...
export function AboutWhat({ contentType = 'aboutCourse', influencer = false }) {
  ...
  const contentDict = {
    aboutCourse: {
      title: ['מה זה ', influencer ? 'Influencers-Pro' : 'Video-Pro'],
    },
    aboutMe: {
            ...
            {contentType === 'aboutMe' && (
              <>
                ...
                >
                  ...
                  בקורס {influencer ? 'Influencers-Pro' : 'Video-Pro'}, אני אחלוק אתכם את כל הסודות
              ...
              <>
                ...
                {influencer ? (
                  <Typography sx={{ opacity: 0.9, lineHeight: 1.7 }} variant="p">
                    ...
                    ולהתחבר למותגים מובילים שמחפשים שותפים יצירתיים לשיתופי פעולה מתגמלים. זהו השער
                    שלכם לעולם התוכן המקצועי, עם תמיכה קבועה בקהילה אקסקלוסיבית שממשיכה לצמוח
                    ולהתעדכן.
                  </Typography>
                ) : (
